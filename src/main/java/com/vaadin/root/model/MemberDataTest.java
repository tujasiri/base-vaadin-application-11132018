...
/**
 * The persistent class for the member_data_test database table.
 * 
 */
@Entity
@Table(name="member_data_test")
@NamedQuery(name="MemberDataTest.findAll", query="SELECT m FROM MemberDataTest m")
public class MemberDataTest implements Serializable {
